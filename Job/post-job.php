...
if(isset($_REQUEST['btnSubmit'])) 
    {
        ...
        $query = "insert into job (jobtitle,categories,skills,ldate,budget,username,description) values ('$jobtitle','$categories','$skills','$ldate','$budget','$username','$description')";
...
<input type="text" class="form-control" required="" name="jobtitle">
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<div class="col-lg-6">
<div class="form-group">
<label>Job Finish Last Date</label>
<input type="date" class="form-control" required="" name="ldate">
</div>
</div>
