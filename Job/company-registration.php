...
if(isset($_REQUEST['btnSubmit'])) 
    {
        ...
        $query = "insert into company (sname,email,company,mobile,address,gender,username,password) values ('$sname','$email','$company','$mobile','$address','$gender','$uername','$password')";
